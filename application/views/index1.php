...
<body>
	...
	<footer>@2020<span class="v88"> V88Studios</span>. All Rights Reserved.<br>Redirect<a href="https://keikishim2.github.io/learning_timeline/"> HERE</footer>
<!-- DOCU: Add Pet-->
					...
					<form class="form-info">
						...
						<div class="modal-footer">
							...
							<div class="button-group">
								<button type="button" id="btn-like" class="btn btn-like-pet" data-dismiss="modal"><i class="fas fa-heart"></i>Like <span 	class="pet-name"></span></button>
								<button type="button" class="btn btn-adopt-pet" data-dismiss="modal"><i class="fa fa-home" aria-hidden="true"></i>Adopt <span class="pet-name"></span></button>
							</div>
						</div>
					</form>
				</div>
